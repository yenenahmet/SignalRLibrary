...
public class HubProxy {
    ...
    public <E1> void on(String eventName, final SubscriptionHandler1 handler, Class<E1> parameter1) {
    ...
    public <E1> void on(String eventName, final SubscriptionHandler1 handler) {
